// ============================================================
// benchmark.cpp — std::vector vs Vector spartos analizė
...
int main() {
    ...
    const std::vector<unsigned int> dydziai = { 10000u, 100000u, 1000000u, 10000000u };
    ...
    const unsigned int N = 10000000u;  // SANDBOX: 10M (tikrame teste 100000000)
    ...
    // std::vector
    {
        ...
        cout << "std::vector (" << N << " el.): " << reallocs
            << " perskirstymai, galutinė capacity = " << v.capacity() << "\n";
    }
    // Vector
    {
        Vector<int> v;
